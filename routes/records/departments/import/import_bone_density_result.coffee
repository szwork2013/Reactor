...
app.put '/records/:barcode/departments/bone_density/data', (req, res) ->
  ...
  .exec (error, record) ->
    ...
    console.log value, references[sex]['ut'], references[sex]['lt'], JSON.stringify original_item.conditions
